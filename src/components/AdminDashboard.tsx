...
export default function AdminDashboard({
  ...
  return (
    <div className="space-y-6 animate-fade-in" id="admin-dashboard-root">
      ...
      <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 bg-slate-900/30 border border-slate-900 rounded-2xl p-5">
        <div>
          <h3 className="text-base font-extrabold text-slate-100 font-mono uppercase tracking-wider flex items-center space-x-2">
        ...
        {/* Outer Command Tabs */}
        <div className="flex flex-wrap items-center gap-1.5 bg-slate-950 p-1.5 rounded-xl border border-slate-850 w-full xl:w-auto font-mono text-[10px] font-bold">
          <button
      ...
      {adminActiveSubTab === 'kpis' && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-950/40 border border-slate-900 p-3 rounded-xl font-mono text-xs">
            <div className="flex items-center space-x-2">
              <Building className="w-4 h-4 text-slate-500" />
              <span className="text-slate-400 font-bold">Select Active Scope:</span>
              <select
                value={selectedBranchFilter}
                onChange={(e) => setSelectedBranchFilter(e.target.value)}
                className="bg-transparent text-xs text-slate-200 outline-none font-bold cursor-pointer"
              >
                <option value="All" className="bg-slate-950">Consolidated Ledger (All Branches)</option>
                <option value="b-yangon" className="bg-slate-950">Yangon Head Office (Kaba Aye)</option>
                <option value="b-mandalay" className="bg-slate-950">Mandalay Division Branch</option>
                <option value="b-naypyitaw" className="bg-slate-950">Naypyitaw Capital Mall</option>
              </select>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-emerald-500/20 text-slate-300 font-bold px-2.5 py-1.5 rounded text-[10px] flex items-center space-x-1"
              >
              ...
              <button
                ...
                className="bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-sky-500/20 text-slate-300 font-bold px-2.5 py-1.5 rounded text-[10px] flex items-center space-x-1"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
            ...
            <div className="bg-slate-900/25 border border-slate-900 rounded-2xl p-4.5 space-y-2 group hover:border-slate-850 transition">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1.5 mt-1 text-[10px] text-slate-400">
                  ...
                  <strong className="text-slate-100">{filteredSales.length} bills</strong>
                  <span className="text-slate-600">•</span>
                  <span>GST/VAT:</span>
                  <strong className="text-slate-100">{totalSalesTax.toLocaleString()}</strong>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/25 border border-slate-900 rounded-2xl p-4.5 space-y-2 group hover:border-slate-850 transition">
              ...
              <div>
                <strong className="text-xl sm:text-2xl text-slate-100 block font-black">
                ...
                <div className="flex items-center space-x-1.5 mt-1 text-[10px] text-slate-400">
                  ...
                  <span className="text-slate-600">•</span>
                  <span>Est COGS:</span>
                  <strong className="text-slate-400">{totalCogs.toLocaleString()}</strong>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/25 border border-slate-900 rounded-2xl p-4.5 space-y-2 group hover:border-slate-850 transition">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1.5 mt-1 text-[10px] text-slate-400">
                  <span>Units:</span>
                  <strong className="text-slate-100">{totalUnitsInStock} pcs</strong>
                  <span className="text-slate-600">•</span>
            ...
            <div className="bg-slate-900/25 border border-slate-900 rounded-2xl p-4.5 space-y-2 group hover:border-slate-850 transition">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1.5 mt-1 text-[10px] text-slate-400">
                  ...
                  <strong className="text-emerald-400">{pendingServiceRevenue.toLocaleString()} MMK</strong>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            {/* Sales Trends Chart */}
            <div className="lg:col-span-8 bg-slate-900/15 border border-slate-900 rounded-2xl p-5 space-y-3">
            ...
            <div className="lg:col-span-4 bg-slate-900/15 border border-slate-900 rounded-2xl p-5 flex flex-col justify-between space-y-4">
              ...
              <div className="h-48 flex items-center justify-center relative">
                ...
                <div className="absolute flex flex-col items-center justify-center text-center">
                  ...
                  <strong className="text-xs font-black text-slate-200 font-mono">
              ...
              <div className="grid grid-cols-2 gap-1 text-[9px] font-mono text-slate-400">
                {getExpensesCategoryData().map((entry, idx) => (
                  <div key={idx} className="flex items-center space-x-1 px-1.5 py-1 bg-slate-950/40 rounded border border-slate-900/40">
                    <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ backgroundColor: entry.color }} />
                    <span className="truncate flex-1">{entry.name}</span>
                    <strong className="text-slate-200">{((entry.value / totalExpenseAmount) * 100).toFixed(0)}%</strong>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div key={idx} className="space-y-1.5 font-mono text-xs">
                      <div className="flex justify-between items-baseline">
                        ...
                        <div className="space-x-1.5 text-[10px]">
                          ...
                          <strong className="text-emerald-400">{b.Revenue.toLocaleString()}</strong>
                          <span className="text-slate-600">|</span>
            ...
            <div className="bg-slate-900/20 border border-slate-900 rounded-2xl p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2.5 font-mono text-xs">
                ...
                <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-900 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-200">{totalCustomersCount}</strong>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="space-y-2.5 font-mono text-xs">
                ...
                <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-900 space-y-1 max-h-[100px] overflow-y-auto">
                  {criticalLowStockList.length > 0 ? (
                    criticalLowStockList.slice(0, 3).map((item, idx) => (
                      <div key={idx} className="flex justify-between text-[10px]">
                        <span className="text-slate-400 truncate max-w-[100px]">{item.productName}</span>
      ...
      {adminActiveSubTab === 'forms' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in">
          ...
          <div className="lg:col-span-4 bg-slate-900/30 border border-slate-900 p-4 rounded-2xl space-y-1.5">
            ...
            {[
              { key: 'sale', label: 'Manual POS Checkout Ticket', icon: DollarSign, color: 'text-emerald-400' },
              { key: 'product', label: 'Catalog New Handset SKU', icon: Plus, color: 'text-indigo-400' },
              { key: 'replenish', label: 'Warehouse Stock Replenish', icon: Package, color: 'text-sky-400' },
                ...
                <button
                  ...
                  className={`w-full flex items-center space-x-2.5 px-3 py-2.5 rounded-xl font-mono text-xs font-bold transition-all text-left ${
                    activeFormType === f.key
                      ? 'bg-slate-950 border border-slate-850 text-white shadow'
          ...
          <div className="lg:col-span-8 bg-slate-900/15 border border-slate-900 p-5 rounded-2xl space-y-4">
            
            {/* Display status banners */}
            {formSuccessMessage && (
              <div className="bg-emerald-500/10 border border-emerald-500/25 p-3.5 rounded-xl text-emerald-400 font-bold font-mono text-xs flex items-start space-x-2">
            ...
            {formSubmitLoading ? (
              <div className="space-y-4 py-8 animate-pulse font-mono text-xs">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="h-10 bg-slate-800 rounded-md" />
                  <div className="h-10 bg-slate-800 rounded-md" />
                </div>
                <div className="h-20 bg-slate-800 rounded-md" />
                <div className="h-10 bg-slate-800 rounded-md w-full mt-6" />
              ...
              <form onSubmit={handleProcessSubmit} className="space-y-4 font-mono text-xs">
                ...
                <div className="border-b border-slate-900 pb-3 flex items-center justify-between">
                  ...
                  <span className="text-[10px] bg-slate-950 px-2 py-0.5 border border-slate-850 rounded text-slate-500">POST Action</span>
                </div>
                ...
                {activeFormType === 'sale' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Choose Handset SKU</label>
                        <select
                          value={saleProductId}
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Color Variant</label>
                        <input
                          type="text"
                          value={saleColor}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Client Telephone (09...)</label>
                        <input
                          type="text"
                    ...
                    <div className="space-y-1">
                      <label className="text-slate-400">Discount Amount (MMK)</label>
                      <input
                        type="number"
                        value={saleDiscount}
                ...
                {activeFormType === 'product' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Handset/Model Name</label>
                        <input
                          type="text"
                          value={prodName}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Brand Designation</label>
                        <select
                          value={prodBrand}
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Original Cost (MMK)</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Selling Price (MMK)</label>
                        <input
                          type="number"
                          value={prodPrice}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Initial Colorway</label>
                        <input
                          type="text"
                          value={prodColor}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Screen specs</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">RAM Variant</label>
                        <input
                          type="text"
                          value={prodSpecs.ram}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Storage capacity</label>
                        <input
                          type="text"
                ...
                {activeFormType === 'replenish' && (
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <label className="text-slate-400">Select Branch Warehouse</label>
                      <select
                    ...
                    <div className="space-y-1">
                      <label className="text-slate-400">Select Product Catalog SKU</label>
                      <select
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Absolute Stock level to Set (Units)</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Minimum Safe Stock Alert Limit</label>
                        <input
                          type="number"
                ...
                {activeFormType === 'transfer' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Origin Branch (Source)</label>
                        <select
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Destination Branch (Target)</label>
                        <select
                    ...
                    <div className="space-y-1">
                      <label className="text-slate-400">Choose Handset SKU to dispatch</label>
                      <select
                    ...
                    <div className="space-y-1">
                      <label className="text-slate-400">Transfer Quantity (Units)</label>
                      <input
                        type="number"
                        value={transferQty}
                ...
                {activeFormType === 'repair' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Diagnostics Lab Branch</label>
                        <select
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Device Brand</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Device Model SKU</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Diagnostics Issue Description</label>
                        <input
                          type="text"
                          value={repairIssue}
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Est. Repair Cost (MMK)</label>
                        <input
                          type="number"
                          value={repairEstCost}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Warranty duration (Mth)</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Assigned Technician</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Client Full Name</label>
                        <input
                          type="text"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Client Contact Mobile</label>
                        <input
                          type="tel"
                ...
                {activeFormType === 'vtu' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-3 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Target Operator</label>
                        <select
                          value={vtuOperator}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Top-up Package</label>
                        <select
                          value={vtuType}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Dispatch Branch</label>
                        <select
                          value={vtuBranchId}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Recipient Phone Number (09...)</label>
                        <input
                          type="tel"
                          value={vtuPhone}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Recharge Amount (Kyats)</label>
                        <input
                          type="number"
                          value={vtuAmount}
                ...
                {activeFormType === 'closing' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Audit Supervisor Name</label>
                        <input
                          type="text"
                          value={closingBy}
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Cash drawer (MMK)</label>
                        <input
                          type="number"
                          value={closingCash}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">KBZPay (MMK)</label>
                        <input
                          type="number"
                          value={closingKPay}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">WavePay (MMK)</label>
                        <input
                          type="number"
                          value={closingWave}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Other Dig (MMK)</label>
                        <input
                          type="number"
                          value={closingOther}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Recorded OPEX cash expense during shift</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Drawer Discrepancy difference</label>
                        <input
                          type="number"
                          value={closingDiff}
                ...
                {activeFormType === 'employee' && (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Full Staff Name</label>
                        <input
                          type="text"
                          value={empName}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Telephone Contact</label>
                        <input
                          type="tel"
                          value={empPhone}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Primary Role designation</label>
                        <select
                          value={empRole}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Branch assigned</label>
                        <select
                          value={empBranchId}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-slate-400">Monthly Sales Target (MMK)</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Commission incentive rate (%)</label>
                        <input
                          type="number"
                          value={empCommission}
                ...
                {activeFormType === 'loyalty' && (
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">Initial loyalty points</label>
                        <input
                          type="number"
                          value={vipPoints}
                      ...
                      <div className="space-y-1">
                        <label className="text-slate-400">VIP Tier status</label>
                        <select
                          value={vipTier}
                    ...
                    <div className="space-y-1">
                      <label className="text-slate-400">Current Outstanding Credit balance (MMK)</label>
                      <input
                        type="number"
                        value={vipDebt}
                        onChange={(e) => setVipDebt(e.target.value)}
                        className="w-full bg-slate-950 border border-slate-800 rounded p-2 text-rose-400 font-bold"
                      />
                    </div>
                  </div>
                )}
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-slate-950 font-black py-3 rounded-xl uppercase transition hover:opacity-90 flex items-center justify-center space-x-1.5 shadow"
                >
      ...
      {adminActiveSubTab === 'integrations' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in">
          ...
          <div className="lg:col-span-7 bg-slate-900/15 border border-slate-900 p-5 rounded-2xl space-y-4">
            <div className="border-b border-slate-900 pb-3 flex items-center justify-between">
              <span className="text-xs font-bold text-slate-100 uppercase tracking-wider font-mono">Third-Party API & Webhook Credentials</span>
              <button
                type="button"
                onClick={() => setShowSecrets(!showSecrets)}
                className="text-slate-400 hover:text-sky-400 text-[10px] font-mono font-bold flex items-center space-x-1"
              >
            ...
            {saveSuccess && (
              <div className="bg-sky-500/10 border border-sky-500/25 p-3 rounded-xl text-sky-400 font-bold font-mono text-xs text-center">
            ...
            <form onSubmit={handleSaveIntegrations} className="space-y-4 font-mono text-xs">
              ...
              <div className="space-y-2.5">
                <span className="text-[10px] text-indigo-400 font-black uppercase tracking-wider block">💬 Telegram Broadcast Integration</span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-slate-400">Telegram Bot API Token</label>
                    <input
                  ...
                  <div className="space-y-1">
                    <label className="text-slate-400">Broadcast Channel Chat ID</label>
                    <input
                      type="text"
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-900/60">
                <span className="text-[10px] text-emerald-400 font-black uppercase tracking-wider block">🌐 Inbound/Outbound Real-time webhooks</span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-slate-400">Partner Webhook Trigger URL</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-slate-400">Webhook Bearer Token</label>
                    <input
                      type={showSecrets ? 'text' : 'password'}
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-900/60">
                <span className="text-[10px] text-sky-400 font-black uppercase tracking-wider block">🗄️ Relational Supabase Cloud Backup</span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-slate-400">Supabase Project URL</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-slate-400">Supabase Service Role Key</label>
                    <input
                      type={showSecrets ? 'text' : 'password'}
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-900/60">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="space-y-1">
                    <label className="text-slate-400">SMS cellular API key</label>
                    <input
                      type={showSecrets ? 'text' : 'password'}
                  ...
                  <div className="space-y-1">
                    <label className="text-slate-400">VTU Merchant ID</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-slate-400">VTU gateway Secret</label>
                    <input
                      type={showSecrets ? 'text' : 'password'}
              ...
              <div className="flex gap-3 pt-3">
                <button
                  ...
                  className="flex-1 bg-sky-500 hover:bg-sky-450 disabled:opacity-50 text-slate-950 font-black py-2.5 rounded-xl uppercase transition"
                >
          ...
          <div className="lg:col-span-5 bg-slate-950 border border-slate-900 rounded-2xl p-5 flex flex-col justify-between h-[480px]">
            <div className="space-y-2.5">
              ...
              <div className="bg-slate-950 p-3.5 border border-slate-900 rounded-xl h-72 overflow-y-auto font-mono text-[10px] text-emerald-400 space-y-2 leading-relaxed">
            ...
            <button
              ...
              disabled={pinging}
              className="w-full bg-slate-900 hover:bg-slate-850 border border-slate-800 text-sky-400 font-bold py-2.5 rounded-xl uppercase transition flex items-center justify-center space-x-1.5"
            >

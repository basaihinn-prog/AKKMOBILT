            ...
            return (
              ...
              >
                ...
                <div className="truncate">
                  <span>{g.label}</span>
                  <span className="text-[9px] text-slate-500 font-normal block truncate">Count: {metaStore[g.key]?.length || 0} entries</span>
                </div>
              </button>
            );
          })}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1 font-mono text-xs">
              {filteredRecords.length > 0 ? (
                ...
                <div className="text-center py-12 text-slate-500 italic">No records registered in this configuration catalog</div>
              )}
            </div>
          </div>
        </div>

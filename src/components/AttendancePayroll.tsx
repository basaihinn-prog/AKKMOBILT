      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Attendance, Leave & Payroll Management</p>
          </div>
        </div>
      </div>
      ...
      {activeTab === 'attendance' && (
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <p className="text-gray-600 text-sm">Avg Work Hours</p>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <input
              ...
              className="mt-2 px-3 py-2 border border-gray-200 rounded-lg w-full max-w-xs"
            />
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700">Work Hours</th>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-3 text-right text-xs font-semibold text-gray-700">Allowances</th>
                  <th className="px-6 py-3 text-right text-xs font-semibold text-gray-700">Deductions</th>
                  <th className="px-6 py-3 text-right text-xs font-semibold text-gray-700">Net</th>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700">Status</th>
                  <th className="px-6 py-3 text-right text-xs font-semibold text-gray-700">Actions</th>
                </tr>
              </thead>
              <tbody>
                {payrollRecords.map((payroll) => (
                  <tr key={payroll.id} className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="px-6 py-4 font-medium text-gray-900">{payroll.employeeName}</td>
                    <td className="px-6 py-4 text-right text-sm text-gray-700">{(payroll.baseSalary / 1000).toFixed(0)}K</td>
                    <td className="px-6 py-4 text-right text-sm text-gray-700">{(payroll.allowances / 1000).toFixed(0)}K</td>
                    <td className="px-6 py-4 text-right text-sm text-gray-700">{(payroll.deductions / 1000).toFixed(0)}K</td>
